...
<div class="max-w-2xl mx-auto animate-fade-in-up">
    <div class="bg-admin-surface border border-admin-border rounded-admin-lg p-6">
        ...
        <form action="{{ route('locations.store') }}" method="POST" class="space-y-6" x-data="{ 
            shiftsCount: {{ old('shift3_name') ? 3 : (old('shift2_name') ? 2 : 1) }},
            shift1Is24: {{ old('shift1_is_24_hours') ? 'true' : 'false' }},
            shift2Is24: {{ old('shift2_is_24_hours') ? 'true' : 'false' }},
            shift3Is24: {{ old('shift3_is_24_hours') ? 'true' : 'false' }}
        }">
            @csrf
            ...
            <div class="border-t border-admin-border pt-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 flex items-center gap-3 mt-1">
                        <input type="checkbox" name="shift1_is_24_hours" id="shift1_is_24_hours" x-model="shift1Is24" value="1" {{ old('shift1_is_24_hours') ? 'checked' : '' }}
                               class="w-4 h-4 text-admin-indigo bg-admin-canvas border-admin-border rounded focus:ring-admin-indigo/25">
            ...
            <div x-show="shiftsCount >= 2" x-cloak class="border-t border-admin-border pt-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="shift2_name" x-ref="shift2_name" value="{{ old('shift2_name') }}" placeholder="Contoh: Shift Sore"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div :class="shift2Is24 ? 'col-span-2' : 'col-span-1'">
                        <label class="text-xs font-semibold text-admin-slate">Jam Masuk</label>
                        <input type="time" name="shift2_jam_masuk" x-ref="shift2_masuk" value="{{ old('shift2_jam_masuk') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div x-show="!shift2Is24" class="col-span-1">
                        <label class="text-xs font-semibold text-admin-slate">Jam Keluar</label>
                        <input type="time" name="shift2_jam_keluar" x-ref="shift2_keluar" value="{{ old('shift2_jam_keluar') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div class="col-span-2">
                        <label class="text-xs font-semibold text-admin-slate">Batas Terlambat</label>
                        <input type="time" name="shift2_batas_terlambat" x-ref="shift2_terlambat" value="{{ old('shift2_batas_terlambat') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div class="col-span-2 flex items-center gap-3 mt-1">
                        <input type="checkbox" name="shift2_is_24_hours" id="shift2_is_24_hours" x-ref="shift2_24h" x-model="shift2Is24" value="1" {{ old('shift2_is_24_hours') ? 'checked' : '' }}
                               class="w-4 h-4 text-admin-indigo bg-admin-canvas border-admin-border rounded focus:ring-admin-indigo/25">
            ...
            <div x-show="shiftsCount >= 3" x-cloak class="border-t border-admin-border pt-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="shift3_name" x-ref="shift3_name" value="{{ old('shift3_name') }}" placeholder="Contoh: Shift Malam"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div :class="shift3Is24 ? 'col-span-2' : 'col-span-1'">
                        <label class="text-xs font-semibold text-admin-slate">Jam Masuk</label>
                        <input type="time" name="shift3_jam_masuk" x-ref="shift3_masuk" value="{{ old('shift3_jam_masuk') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div x-show="!shift3Is24" class="col-span-1">
                        <label class="text-xs font-semibold text-admin-slate">Jam Keluar</label>
                        <input type="time" name="shift3_jam_keluar" x-ref="shift3_keluar" value="{{ old('shift3_jam_keluar') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div class="col-span-2">
                        <label class="text-xs font-semibold text-admin-slate">Batas Terlambat</label>
                        <input type="time" name="shift3_batas_terlambat" x-ref="shift3_terlambat" value="{{ old('shift3_batas_terlambat') }}"
                               class="w-full mt-1 px-4 py-2.5 bg-admin-canvas rounded-admin-md border border-admin-border text-sm text-admin-ink focus:outline-none focus:ring-2 focus:ring-admin-indigo/25">
                    </div>
                    <div class="col-span-2 flex items-center gap-3 mt-1">
                        <input type="checkbox" name="shift3_is_24_hours" id="shift3_is_24_hours" x-ref="shift3_24h" x-model="shift3Is24" value="1" {{ old('shift3_is_24_hours') ? 'checked' : '' }}
                               class="w-4 h-4 text-admin-indigo bg-admin-canvas border-admin-border rounded focus:ring-admin-indigo/25">
...
(function() {
    ...
    // Fix size if container loaded hidden
